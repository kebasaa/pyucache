...
6. The current time is read. If it is more than 2s off from the computer time (in UTC, this tolerance is an option in the class function _check_and_update_time()_), it is updated to match the computer time (in UTC).
